              ...
              <tbody>
                ...
                /*  $sql="SELECT l.*,e.name,l.model_name AS model_name, l.cat_id AS cat_id,
                 ...
                 /*   $sql="SELECT l.*,e.name,l.model_name AS model_name, l.cat_id AS cat_id,
                  ...
                  DATE_FORMAT(end_date,'%d-%m-%Y') AS 'end_date',  
                  DATE_FORMAT(end_time,'%h:%i %p') AS 'end_time' FROM
                  lend_details l,end_users e where l.user_id=e.id and lend_accept='1' and check_stock='1' order by l.id desc";   */


                 $sql= "SELECT l.*,e.name,l.model_name AS model_name, l.cat_id AS cat_id, rc.name as category,
                  DATE_FORMAT(start_date,'%d-%m-%Y') AS 'start_date',
                  DATE_FORMAT(start_time,'%h:%i %p') AS 'start_time',
                  DATE_FORMAT(end_date,'%d-%m-%Y') AS 'end_date',  
                  DATE_FORMAT(end_time,'%h:%i %p') AS 'end_time' FROM
                  lend_details l,end_users e, rent_lend_categories rc where l.user_id=e.id and lend_accept='1' and rc.id=l.cat_id and check_stock='1' order by l.id desc";
                       ...
                       { 
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="update_user_accept.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-xs">View</a>
