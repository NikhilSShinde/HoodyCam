...
<?php include('config.php');
 ...
 $row1 = mysqli_fetch_assoc($result1);
  ...
  $sql2 = "SELECT * FROM cameraman_signups Where id=$cid"; 
              ...
              <div class="col-md-12">
                <div class="x_panel" style="margin-top: 57px;">
                  ...
                  <!--  <div class="item form-group">
                      ...
                      <span class="section">Allocated Cameraman Details</span>
                      ...
                      <div class="item form-group"> 
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row2['name']?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                        
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Mobile Number</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row2['mobile1']?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">E-Mail</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                         <input type="text" value="<?php echo $row2['email']?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                        
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Address</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row2['address']?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                       </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-offset-5">
                          ...
                          <a href="allocated_request.php" class="btn btn-warning">Back</a>
