            ...
            <div class="row">
              <!-- <div class="col-md-12 "> -->
                ...
                <div class="x_panel" style="margin-top: 57px;">
                  <div class="x_content">
                    <div class="row">
                     <span class="section">Product In Use</span>    
                ...
                <?php 
                      ...
                      $sql="SELECT t.*,e.name, 
                        ...
                        l.id=t.lend_details_id AND r.id=t.rent_details_id AND t.end_trip is null AND e.id=l.user_id";
              ...
              ?>
                <tr>
                  ...
                  <td>
                      <a href="view_camera_in_use.php?id=<?php echo $row['id'];?>">
