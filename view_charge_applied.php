...
include('config.php');
 ...
 if( ($datetime1 < $datetime2) || ($datetime1 == $datetime2))
 {
  ...
  $sql4 = "SELECT * FROM feedback WHERE trip_id='".$id."'";
      ...
      <!-- page content -->
        <div class="right_col" role="main">
            <div class="row">
                    ...
                    <form  class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                         <input type="text" value="<?php echo $row2['Amount']; ?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                       </div>


                      <div class="item form-group">
                       <label class="control-label col-md-2 col-sm-2 col-xs-12">Feedback</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <textarea class="form-control" readonly="readonly"><?php echo $row4['feed_desc']; ?></textarea>
                        </div>

                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Ratings</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                         <input type="text" value="<?php echo $row4['stars']; ?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                       </div>
              ...
              <span class="section">Applied Charges</span>  
              ...
              <div class="item form-group">
                  ...
                  <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Applied Taxes
                        </label>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text"  value="<?php echo $row['extra_charge']; ?>" name="ext_charge" class="form-control prc col-md-7 col-xs-12"  readonly="readonly">
                        </div>
                        
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Extra Time Charges</label>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row['extra_time_charge']; ?>" name="ext_time_charge" class="form-control prc col-md-7 col-xs-12"  readonly="readonly">
                        </div>
                  </div>  

                  <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Damage Charges
                        </label>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row['damage_charge']; ?>" name="damage_charge" class="form-control prc col-md-7 col-xs-12"  readonly="readonly">
                        </div>

                         <label class="control-label col-md-2 col-sm-2 col-xs-12">Total Charges
                        </label>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php echo $row['total_amount']; ?>" name="total_charge" class="form-control  col-md-7 col-xs-12" readonly="readonly">
                        </div>
                      ...
                      <div class="col-md-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-5 ">
                      ...
                      <a href="charge_applied.php" class="btn btn-warning">Back</a>
