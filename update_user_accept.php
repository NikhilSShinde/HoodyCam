...
<?php include('config.php');
  ...
  $sql="SELECT l.*,e.name,rc.name as category,
  DATE_FORMAT(start_date,'%d-%m-%Y') as 'start_date',
  DATE_FORMAT(start_time,'%h:%i %p') AS 'start_time',
  DATE_FORMAT(end_date,'%d-%m-%Y') as 'end_date',
  DATE_FORMAT(end_time,'%h:%i %p') AS 'end_time'
  FROM lend_details l, end_users e, rent_lend_categories rc where l.user_id=e.id and l.cat_id=rc.id and l.id=$id"; 
                  ...
                  <form action="LendStatus.php" method="POST" class="form-horizontal form-label-left"  onSubmit="if(!confirm('Are you sure ?')){return false;}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="item form-group">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">Category</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?php  echo $row['category']?>" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Model Name</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" name="model_name" id="txtNoSpaces" onpaste="return false;" value="<?php  echo $row['model_name']?>" class="form-control col-md-7 col-xs-12">
                        </div>
...
<!-- /media gallery -->
                      ...
                      <div class="form-group">
                        <div class="col-md-8 col-sm-offset-4 col-xs-offset-4">
                     ...
                     <!-- <?php if($status==null) { ?>
                      ...
                      <button class="btn btn-info btn-md" class="" value="<?php echo $row['id'];?>" name="update" type="submit">Update</button>
                      <a href="user_accept.php"  class="btn btn-warning">Back</a>
                       </div>
                      </div>
                    </form>
