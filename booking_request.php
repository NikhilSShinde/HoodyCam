...
<html lang="en">
  <head>
    ...
    <title>photoshoot Request</title>
            ...
            <div class="row">
              <!-- <div class="col-md-12 "> -->
                ...
                <div class="x_panel" style="margin-top: 57px;">
                  <div class="x_content">
                      <span class="section">Request for Cameraman (Transaction Aborted)</span>
                    <div class="row">
                  ...
                  <div class="table-responsive">
                     ...
                     $sql="SELECT u.*, e.name, e.email as email,
                      ...
                      u.id=o.photo_details_id AND o.id=t.order_id AND e.id=u.user_id AND
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                           <a href="view_booking_request.php?id=<?php echo $row['id'];?>" class="btn btn-warning btn-xs" value="">View</a>
                         </td>
