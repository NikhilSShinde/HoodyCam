            ...
            <div class="row">
              ...
              <tbody>
                ...
                <?php
                  ...
                  lend_details l,end_users e where l.user_id=e.id and ad_verify='1' and lend_accept is null order by l.id desc";   


                   // $sql=("SELECT l.*,DATE_FORMAT(start_date,'%d-%m-%y') as 'start_date',DATE_FORMAT(end_date,'%d-%m-%y') as 'end_date', e.name,l.model_name as model_name, l.cat_id as cat_id FROM lend_details l, end_users e, view_packages v  where l.user_id=e.id and l.cat_id=v.cat_id and ad_verify='1'");   
                       ...
                       { 
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['end_date'];?> |
                             ...
                             <!--  <td></td> -->
                          <td>
                              <a href="view_verified_lend_camera.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-xs">View</a>
