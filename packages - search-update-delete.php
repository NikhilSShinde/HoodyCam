        ...
        <div class="right_col" role="main">
          <!-- <div class=""> -->
            ...
            <div class="row">
                    ...
                    <div class="item-form-group">
                              ...
                              <label class="control-label col-md-2 col-sm-2 col-xs-6" for="Category name">Select Category<span class="required">*</span></label>
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-6 form-group">
                                  ...
                                  <select class="form-control" name="category_name" id="iface">
                                  ...
                                  <?php
                                        ...
                                        if($return1 > 0)
                                        {
                                          while($row1 = mysqli_fetch_array($result1))
                                  {?>
                                              <option value="<?php echo ($row1['rent_lend_cat_name']); ?>"><?php echo ($row1['rent_lend_cat_name']); ?> </option>
              ...
              <div class="col-md-12">
                   <table id="datatable-fixed-header1" class="table table-striped table-bordered table-responsive">
                      <thead>
                        <tr>
                          <th>Category Name</th>
                          <th>Package No</th>
                      ...
                      include('config.php');
                                        $sql2=("SELECT * FROM view_packages v,rent_lend_category r where v.rent_lend_cat_id=r.rent_lend_cat_id order by v.rent_lend_cat_id");                           
                       ...
                       while($row2 = mysqli_fetch_assoc($result2))  {  ?>
                        <tr>
                          <td><?php  echo $row2['rent_lend_cat_name']?>
                          ...
                          <button class="btn btn-danger btn-xs" value="" data-toggle="modal" data-target="#myModal1<?php echo $row2['sr_no']; ?>">Reject</button></td>
                           </tr>
<!-- Modal -->
  ...
  <!-- modal end -->
         ...
         <!-- Modal 1 -->
                      <div class="modal fade" id="myModal1<?php echo $row2['sr_no']; ?>" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="delete_package.php?id=<?php echo $row2['sr_no']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                            </div>
                          </div>
