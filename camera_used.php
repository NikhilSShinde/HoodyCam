...
<html lang="en">
 ...
 <span class="section">Product Used (Apply charges if any)</span>  
                ...
                <?php 
                      ...
                      $sql="SELECT t.*,e.name, 
                        ...
                        l.id=t.lend_details_id AND r.id=t.rent_details_id AND t.end_trip is not null AND t.total_amount is null AND  e.id=l.user_id";
              ...
              ?>
                <tr>
                 ...
                 <!--  <td><textarea readonly="readonly"> <?php echo $row['damage_desc'];?>
                  ...
                  <td>
                      <a href="view_camera_used.php?id=<?php echo $row['id'];?>">
